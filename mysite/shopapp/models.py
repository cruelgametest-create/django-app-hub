...
class ProductImage(models.Model):
    """
    Модель ProductImage представляет изображение,
    которое можно добавить в интернет-магазине к товару.
...
class Order(models.Model):
    ...
    который можно создать в интернет-магазине из списка товаров.
